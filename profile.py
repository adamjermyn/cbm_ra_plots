...
spec = gridspec.GridSpec(ncols=2,nrows=3, figure=fig, width_ratios=(1,1), height_ratios=(1,1,1), wspace=0, hspace=0)
...
axes[0][0].set_xlim([5.45,3.9])
axes[0][0].set_ylim([0.05,0.45])
axes[1][0].set_xlim([5.45,3.9])
axes[1][0].set_ylim([0,7.5])
axes[2][0].set_xlim([5.45,3.9])
...
axes[0][1].set_xlim([5.45,4.3])
axes[0][1].set_ylim([0.05,0.45])
axes[1][1].set_xlim([5.45,4.3])
axes[1][1].set_ylim([0,7.5])
axes[2][1].set_xlim([5.45,4.3])
